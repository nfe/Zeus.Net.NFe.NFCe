...
namespace NFe.Servicos
{
    public sealed class ServicosNFe : IDisposable
    {
        ...
        public RetornoRecepcaoEvento RecepcaoEvento(int idlote, List<evento> eventos, ServicoNFe servicoEvento, VersaoServico versaoEvento)
        {
        ...
        /// <param name="servicoEvento">Tipo de serviço do evento: valores válidos: RecepcaoEventoCancelmento, RecepcaoEventoCartaCorrecao, RecepcaoEventoEpec e RecepcaoEventoManifestacaoDestinatario</param>
        /// <returns>Retorna um objeto da classe RetornoRecepcaoEvento com o retorno do serviço RecepcaoEvento</returns>
        private RetornoRecepcaoEvento RecepcaoEventoEAssina(int idlote, List<evento> eventos, ServicoNFe servicoEvento, VersaoServico versaoEvento)
        {
            var listaEventos = new List<ServicoNFe>
            {
                ServicoNFe.RecepcaoEventoCartaCorrecao,
            ...
            string protocoloAutorizacao, string chaveNFe, string justificativa, string cpfcnpj)
        {
            ...
            var retorno = RecepcaoEventoEAssina(idlote, new List<evento> { evento }, ServicoNFe.RecepcaoEventoCancelmento, _cFgServico.VersaoRecepcaoEventoCceCancelamento);
            return retorno;
        }
            ...
            string correcao, string cpfcnpj)
        {
            ...
            var retorno = RecepcaoEventoEAssina(idlote, new List<evento> { evento }, ServicoNFe.RecepcaoEventoCartaCorrecao, _cFgServico.VersaoRecepcaoEventoCceCancelamento);
            return retorno;
        }
            ...
            string veraplic)
        {
            ...
            var retorno = RecepcaoEventoEAssina(idlote, new List<evento> { evento }, ServicoNFe.RecepcaoEventoEpec, _cFgServico.VersaoRecepcaoEventoEpec);
            return retorno;
        }
